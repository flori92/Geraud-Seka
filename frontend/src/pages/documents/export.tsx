...
import {
    ...
    ArrowRight, FileSpreadsheet, Database
} from "lucide-react";
...
export default function DocumentsExportPage() {
    ...
    const fetchDocuments = async () => {
        ...
        try {
            ...
            console.error("Erreur lors du chargement des documents à exporter:", error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleExport = async () => {
        if (selectedDocs.length === 0) {
            alert("Veuillez sélectionner au moins un document à exporter");
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                alert(`${selectedDocs.length} document(s) exporté(s) avec succès vers la comptabilité`);
                setSelectedDocs([]);
    ...
    const getStats = (): DocumentStats => {
        return {
            ...
            ready_to_export: documents.length,
        };
    };
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                ...
                <p className="text-sm text-gray-600 mt-3">Chargement des documents à exporter...</p>
            </div>
        );
    }
    ...
    return (
        <>
            <Head>
                <title>Export Comptabilité - SEKA</title>
            </Head>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center py-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <h1 className="text-2xl font-bold text-gray-900">Export Comptabilité</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <p className="text-sm font-medium text-gray-600">Prêts à export</p>
                                    <p className="text-2xl font-bold text-gray-900">{stats.ready_to_export}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white shadow rounded-lg">
                        <div className="px-6 py-4 border-b border-gray-200">
                            <div className="flex items-center justify-between">
                                <h2 className="text-lg font-medium text-gray-900">Documents à exporter</h2>
                        ...
                        {filteredDocuments.length === 0 ? (
                            <div className="p-12 text-center">
                                ...
                                <p className="text-gray-600 mb-4">Aucun document prêt pour l'export</p>
                                <button
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {filteredDocuments.map((doc) => {
                                            ...
                                            const docType = doc.type === 'INVOICE_PURCHASE' ? 'Achat' : 
                                                          doc.type === 'INVOICE_SALES' ? 'Vente' : 'Devis';
                                            ...
                                            return (
                                                <tr key={doc.id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="text-sm text-gray-900">
                                                            {doc.document_date ? new Date(doc.document_date).toLocaleDateString('fr-FR') : 'N/A'}
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4">
