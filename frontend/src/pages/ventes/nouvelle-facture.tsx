...
export default function NouvelleFacture() {
  ...
  return (
    <>
      <Head>
        <title>Nouvelle facture - SEKA</title>
      </Head>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">Créez une nouvelle facture client</p>
              </div>
              <Button
                variant="secondary"
                onClick={() => router.push("/ventes/factures")}
              >
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                ...
                <div>
                  <div className="mb-4 flex items-center justify-between">
                    <label className="text-sm font-medium text-gray-900">Articles de la facture</label>
