                        ...
                        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4">
                                    ...
                                    <li><a href="/register" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">Essai gratuit</a></li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-white">Support</h3>
                                <ul className="mt-6 space-y-4">
                                    <li><a href="/docs" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">Documentation</a></li>
                                    <li><a href="#contact" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">Contact</a></li>
                                    <li><a href="/faq" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">FAQ</a></li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-white">Entreprise</h3>
                                <ul className="mt-6 space-y-4">
                                    <li><a href="/about" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">À propos</a></li>
                                    <li><a href="/blog" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">Blog</a></li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-white">Légal</h3>
                                <ul className="mt-6 space-y-4">
                                    <li><a href="/privacy" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">Confidentialité</a></li>
                                    <li><a href="/terms" className="text-sm leading-6 text-gray-400 transition-colors hover:text-white">CGU</a></li>
                                </ul>
                            </div>
                        </div>
